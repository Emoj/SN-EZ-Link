...
closeness_centrality = bipartite.closeness_centrality(B, locationSet)
degree_centrality = bipartite.degree_centrality(B, locationSet)
betweenness_centrality = bipartite.betweenness_centrality(B, locationSet)
#==============================================================================
